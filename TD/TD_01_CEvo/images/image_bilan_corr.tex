...
%%% A COMPLETER AVEC LES NOEUDS VOULUS
\node[text width={(1cm+1em/3)/.6-1em/3*.6},scale=.6,anchor=north,,draw=gray,fill=gray!20,align=center,rectangle] (bdebut) at ($(b.south)+(0,-.8)$)   {105 \% de marge d'où le bridage nécessaire};
\node[text width={(1cm+1em/3)/.7-1em/3*.7},scale=.7,anchor=north,,draw=gray,fill=gray!20,align=center,rectangle] (bfin) at ($(bdebut.south)+(0,-2.05)$)   {\num{1.5} \% de marge  };
\end{scope}
...
%%% A COMPLETER AVEC LES NOEUDS VOULUS
\node[text width={(2.5cm+1em/3)/.7-1em/3*.7},scale=.7,anchor=north,draw=cyan,fill=cyan!20,rectangle,text badly centered] (cdebut) at ($(c.south)+(0,-1.2)$)   {Le scooter peut aller à \SI{246}{km.h^{-1}}};
\node[text width={(2.5cm+1em/3)/.6-1em/3*.6},scale=.6,anchor=north,draw=cyan,fill=cyan!20,rectangle,text badly centered] (c2) at ($(cdebut.south)+(0,-.65)$)   {3 s pour atteindre \SI{100}{km.h^{-1}}};
...
\node[text width={(2.5cm+1em/3)/.7-1em/3*.7},scale=.7,anchor=north,draw=cyan,fill=cyan!20,rectangle,text badly centered] (cfin) at ($(c3.south)+(0,-.2)$)   {100 m départ arrêté en \SI{6.5}{s} };
\end{scope}
