...
\subparagraph{}\textbf{Facultatif \; } \textit{Calculer le temps du 1\ier maximum et en déduire le
...
\subparagraph{}\textbf{Facultatif \; }\textit{Vérifier le cahier des charges en réponse à une variation en échelon de la consigne de glissement relatif.}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\subparagraph{}\textbf{Facultatif \, }\textit{En utilisant cette fonction de transfert, donner l’expression de l’évolution
...
\subparagraph{}\textbf{Facultatif \, }\textit{Tracer l’allure de l’évolution temporelle du glissement relatif $\nu_1(t)$ en précisant
...
\subparagraph{}\textbf{Facultatif \, }\textit{Conclure sur les performances obtenues vis-à-vis des exigences du cahier des charges en réponse à des variations de l’adhérence.}
\ifprof
\begin{corrige}
\end{corrige}
\else
