...
$ = \arg \left[
\underbrace{\dfrac{2000}{1+0,1p+0,01p^2}}_{\to 0 \text{ qd } \omega=\omega_c} 
\cdot
\underbrace{\dfrac{1}{1+0,05p}}_{\to 0 \text{ qd } \omega=\omega_c} 
\cdot 
 \underbrace{K_r}_{\to 0}
 \left(1+\dfrac{1}{T_i p} \right) \cdot 
\underbrace{\dfrac{45\cdot 10^{-6}}{p}}_{\to -90\degres } 
\right] $
$ = \arg \left[  \left(1+\dfrac{1}{T_i p} \right) \right] -90$
...
\end{rem}
$ \arg \left[\text{FTBO}\left( j \omega\right)\right] = \arg \left[  \dfrac{T_i p+1}{T_i p}  \right]-90 $
$ = \arctan (T_i \omega) -90-90$.

$\arg \left[\text{FTBO}\left( j \omega_c\right)\right]-\left(-180\right)=60$
$\Leftrightarrow  \arctan (T_i \omega_c) -180 +180 =60$
$\Leftrightarrow  \arctan (T_i \omega_c)  =60$
$\Rightarrow  T_i =\tan(60)=\SI{1,73}{s}$.
