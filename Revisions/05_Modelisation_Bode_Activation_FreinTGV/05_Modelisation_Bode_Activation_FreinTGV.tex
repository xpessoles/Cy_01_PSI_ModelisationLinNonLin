...
pneumatique, installé sur les TGV Duplex. Par soucis de sécurité, on souhaite en particulier éviter le blocage des roues (phénomène appelé enrayage) lors du freinage. Pour cela il est nécessaire de maîtriser la vitesse de glissement entre la roue et le rail.
\begin{obj}
...
Enfin, les problèmes liés à l’évolution de la vitesse $V_T$ ne font pas l’objet de cette étude.
