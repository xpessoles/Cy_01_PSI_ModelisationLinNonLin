...
\footnotesize
\begin{methode}
Si on note $\omega_c$ on définit la pulsation de coupure telle que $|H\left(j \omega_c \right)| = \SI{0}{dB}$. On peut alors définir la marge de phase par $M\varphi=\arg H\left( j \omega_c\right)-\left(-180\degres\right)$.
\end{methode}
