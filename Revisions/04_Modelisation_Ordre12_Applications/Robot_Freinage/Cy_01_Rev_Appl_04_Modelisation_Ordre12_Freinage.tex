...
\def\xxauteur{\textsl{David Violeau}}
...
\def\xxfigures{
\includegraphics[width=.8\linewidth]{images/image1.png}%images/prot_01}
...
%%\begin{center}
%%\includegraphics[width=.95\linewidth]{images/image3.png}
%%
%%\textbf{Figure 3 :} Pédales de frein
%%\end{center}
%%   
%%\begin{center}
%%\includegraphics[width=.95\linewidth]{images/image4.png}
%%
%%\textbf{Figure 4}
%%\end{center}            
%%
...
%%
%%\begin{center}
%%\includegraphics[width=.5\linewidth]{images/image5.png}
%%\end{center}
%%
%%\subparagraph{}
