...
Étant donné que le modèle utilisé est à retour unitaire, l’écart $\varepsilon(t)$ est égal à l’erreur $\mu(t)$. La précision statique du système est définie par les paramètres suivants :
\begin{itemize}
