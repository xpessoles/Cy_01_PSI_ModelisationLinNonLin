...
\subparagraph{}
\textit{Exprimer $\Omega(p)$ en fonction de $U(p)$ et $C_r(p)$. Les fonctions de transfert seront exprimées sous forme canonique. Les constantes d'un système du second ordre seront explicitées.}
