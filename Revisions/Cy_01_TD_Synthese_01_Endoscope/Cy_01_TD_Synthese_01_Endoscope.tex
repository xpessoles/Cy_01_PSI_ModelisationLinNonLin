...
$\Leftrightarrow  \dfrac{\dd^2 z(t)}{\dd t^2} + \dfrac{f_0}{m_1} \dfrac{\dd z (t)}{\dd t}+\dfrac{k_0}{m_1} z = 0$. 

On a donc $\omega_{03}^2=\dfrac{k_0}{m_1}$ et $\dfrac{2\xi_3}{\omega_{03}}=\dfrac{m_1}{f_0}$ et $\xi_3 =\dfrac{m_1}{2f_0}\sqrt {\dfrac{m_1}{k_0}}$.
\end{corrige}
\else
\fi
