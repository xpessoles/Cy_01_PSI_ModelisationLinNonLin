...
\def\xxactivite{DM 1 \\ Pour le 19/09/2017}
...
\begin{center}
\includestandalone[width=.6\linewidth]{images/SchemaBlocs}
\end{center}
\end{corrige} \else \fi
...
\begin{center}
\includegraphics[width=.4\linewidth]{images/cor_02}
\end{center}
...
\begin{center}
\includegraphics[width=.6\linewidth]{images/cor_03}
\end{center}
...
\end{corrige} 
\begin{center}
\includegraphics[width=.5\linewidth]{images/cor_04}
\end{center}
\else \fi
