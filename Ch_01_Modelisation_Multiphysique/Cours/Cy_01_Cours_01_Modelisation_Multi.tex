...
\begin{center}
\includegraphics[width=.9\linewidth]{Bilbio_SimMeca}
\end{center}
...
\begin{center}
\includegraphics[width=.9\linewidth]{Maxpid_linearisation}
\end{center}
...
\begin{center}
\includegraphics[width=3.5cm]{sat}
...
\begin{minipage}[c]{.48\linewidth}
\begin{center}
\includegraphics[width=.9\linewidth]{Modele_MCC}

\includegraphics[width=.9\linewidth]{Modele_MCC_sat}
\end{center}
\end{minipage}
