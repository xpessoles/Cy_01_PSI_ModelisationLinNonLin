...
\subparagraph{}\textit{Compléter le schéma bloc de la figure 18 du document réponse DR2 par les
transmittances manquantes ****. }
\ifprof
\begin{corrige}~\\
\end{corrige}
\else
...
\subparagraph{}\textit{En déduire la fonction de transfert $M(p)=\dfrac{\Omega(p)}{U(p)}$ du moteur que l’on
